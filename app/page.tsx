    ...
    <main className='flex min-h-screen w-full bg-gray-400 place-content-center'>
      ...
      <div className='flex flex-col w-[8.5in] min-h-screen bg-white justify-between' >
        ...
        <div className='flex flex-col w-full bg-headerBlue h-48 items-center place-content-center gap-2 shadow'>
          <div className='text-4xl font-thin uppercase tracking-widest'>Rick Batka</div>
          <div className='text-sm font-light uppercase tracking-[0.35em] text-gray-200'>Senior Engineering Leader</div>
        </div>
        ...
        <div className="flex h-full p-8 gap-8 text-sm text-black">
          ...
          <div className="flex flex-1 flex-col gap-4">
            ...
            <p>Senior engineering leader with 15 years of experience shipping software. Currently focused on games, education, modelling and simulation, distributed systems, and multiplayer experiences.</p>
            <SectionHeading>Experience</SectionHeading>
            <JobExperience
              company="Bedrock Learning, Inc."
              jobTitle="CTO & Co-Founder"
              timeframe="2022 - Current"
              stack="Typescript, Unreal, WebGL, PlayCanvas, React, Azure, PostgreSQL">
              <ul className="list-disc pl-8">
                <li>Built web game development and publishing platform for educational and serious games</li>
                ...
                <li>Oversaw sucessful attainment of SOC-2 Type 2 and NIST 800-171 cybersecurity compliance accreditations</li>
            ...
            <JobExperience
              ...
              <ul className="list-disc pl-8">
                ...
                <li>Designed, built, and shipped distributed wide-column database for recording dense time-series simulation data</li>
